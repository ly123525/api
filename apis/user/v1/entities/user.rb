    ...
    module User
      ...
      class PersonalCenter < Grape::Entity
        ...
        expose :section do |m, o|
          ...
          {name: "足迹", scheme: "lvsent://gogo.cn/web?url="+Base64.urlsafe_encode64("http://39.107.86.17:8080/#/good_goods?"), icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/history_icon.png', dot_display: false },
          ...
          {name: "收藏", scheme: "lvsent://gogo.cn/web?url="+Base64.urlsafe_encode64("http://39.107.86.17:8080/#/footprint"), icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/collect_icon.png', dot_display: false },
