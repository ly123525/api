    ...
    module User
      ...
      class PersonalCenter < Grape::Entity
        ...
        expose :section do |m, o|
          ...
          {name: "地址管理", scheme: "lvsent://gogo.cn/web?url="+Base64.urlsafe_encode64('http://39.107.86.17:8080/#/account/addresses').delete("="), icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/address_icon.png', dot_display: false },
