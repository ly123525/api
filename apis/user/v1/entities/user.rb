    ...
    module User
      ...
      class PersonalCenter < Grape::Entity
        ...
        expose :section do |m, o|
          ...
          {name: "收藏", scheme: "lvsent://gogo.cn/web?url="+Base64.urlsafe_encode64("http://localhost:8686/#/good_goods"), icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/collect_icon.png', dot_display: false },
