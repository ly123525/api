    ...
    module User
      ...
      class PersonalCenter < Grape::Entity
        ...
        expose :section do |m, o|
          [
          {name: "地址管理", scheme: "lvsent://gogo.cn/web?url="+Base64.urlsafe_encode64("http://h5.ggoo.net.cn/#/account/addresses?type='personal'"), icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/address_icon.png', dot_display: false },
          ...
          {name: "收藏", scheme: nil, icon: 'http://gogo-bj.oss-cn-beijing.aliyuncs.com/app/collect_icon.png', dot_display: false },
