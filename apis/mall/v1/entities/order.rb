    ...
    module Mall
      class OrderToBeConfirmed < Grape::Entity
        ...
        expose :address_scheme do |m, o|
          'lvsent://gogo.cn/web?url=' + Base64.urlsafe_encode64("http://h5.ggoo.net.cn/#/account/addresses?type='order'")
        end
      ...
      class Order < Grape::Entity
        ...
        expose :pay_center_scheme do |m, o|
          "lvsent://gogo.cn/web?url=" + Base64.urlsafe_encode64("http://h5.ggoo.net.cn/#/cashier?order_uuid=#{m.uuid}") if (m.created? && m.expired_at >= Time.now)
        end
        expose :to_refund_scheme do |m, o|
           "lvsent://gogo.cn/web?url=" + Base64.urlsafe_encode64("http://h5.ggoo.net.cn/#/after_sale?order_uuid=#{m.uuid}") unless (m.created? || m.closed? || m.refunded? || m.fight_group.try(:waiting?) || m.evaluated?)
        end  
        ...
        expose :inviting_friends_info do |m, o|
          if m.fight_group.present? && m.fight_group.waiting?
            ...
            {
              url: "http://h5.ggoo.net.cn/#/share?fight_group_uuid=#{m.fight_group.try(:uuid)}",
              image: image,
              title: "来拼",
              summary: "来拼"
            }
      ...
      class Orders < Grape::Entity
        ...
        expose :pay_center_scheme do |m, o|
          "lvsent://gogo.cn/web?url=" + Base64.urlsafe_encode64("http://h5.ggoo.net.cn/#/cashier?order_uuid=#{m.uuid}") if m.created?
        end
        expose :removeable do |m, o|
          m.removeable?
        end
          ...
          if o[:fight_group]
            {
              ...
              url: "http://h5.ggoo.net.cn/#/share?fight_group_uuid=#{o[:fight_group].uuid}",
              description: '快来拼单吧'
            }
          else
            {
              ...
              url: "http://h5.ggoo.net.cn/#/share?uuid=#{m.order_items.first.product.uuid}",
              description: '快来拼单吧'
            }
          end
        end
